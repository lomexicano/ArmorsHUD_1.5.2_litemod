...
# Installation
Drop the .litemod file in the mods folder. You must have LiteLoader installed in order to run this mod. 

# Settings
The default key to open the GUI is "Y". It may be chosen in the control settings of the game.
